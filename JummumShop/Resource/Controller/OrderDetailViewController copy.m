...
//            Branch *branch = [Branch getBranch:receipt.branchID];
            ...
            if(receipt.discountValue == 0 && receipt.serviceChargePercent == 0)//3 rows
            {
                switch (item)
                {
                    case 0:
                    {
                        ...
                        cell.lblTitle.font = [UIFont fontWithName:@"Kanit-SemiBold" size:15.0f];
                        cell.lblAmount.textColor = cSystem1;
                        cell.lblAmount.font = [UIFont fontWithName:@"Kanit-SemiBold" size:15.0f];
                    ...
                    case 1:
                    {
                        ...
                        cell.vwTopBorder.hidden = YES;
                        cell.lblTitle.textColor = cSystem4;
                        cell.lblTitle.font = [UIFont fontWithName:@"Kanit-Regular" size:15.0f];
                        cell.lblAmount.textColor = cSystem4;
                        cell.lblAmount.font = [UIFont fontWithName:@"Kanit-Regular" size:15.0f];
        ...
        else if(section == 2)
        {
            if(item == 0)
            {
                ...
                UIColor *color = cSystem4;//[Receipt getStatusColor:receipt];
                
                
                
                UIFont *font = [UIFont fontWithName:@"Kanit-SemiBold" size:14.0f];
                ...
                UIFont *font2 = [UIFont fontWithName:@"Kanit-Regular" size:14.0f];
